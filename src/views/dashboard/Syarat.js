    ...
    <CRow className="justify-content-center">
      <CCol xs={8}>
        <CCard className="mb-6">
          <CCardHeader>
            <CCardTitle>Syarat Dan Ketentuan</CCardTitle>
          </CCardHeader>
          <CCardBody>
            <CRow className="justify-content-center">
              <CCol sm={10}>
                <ul>
                  ...
                  <li>
                    Membayar biaya pelatihan Bahasa jepang selama 4-6 bulan plus ikut test JLFT /
                    JFT sebesar Rp. 5.000.000
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <ul>
                      ...
                      <li>
                        Uang saku ( selama perjalanan, akomodasi, melas ) untuk 1 bulan pertama
                        kerja di jepang
                      </li>
