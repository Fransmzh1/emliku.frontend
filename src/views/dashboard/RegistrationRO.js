...
const RegistrationRO = () => {
  ...
  const handleUploadFiles = async (e) => {
    ...
    let _loginfo = JSON.parse(localStorage.getItem('loginfo'))
    const fileHeaders = {
  ...
  useEffect(() => {
    ...
    console.log('Useeffek ' + JSON.stringify(_loginfo))
    let r = info
            ...
            <CRow>
              ...
              <CCol>
                ...
                <CRow>
                  ...
                  <CCol sm={6}>
                    {/* <CFormInput size="sm" type="text" id="bank" onChange={handleInfoChange} /> */}
                    <CFormSelect size="sm" id="bank" onChange={handleInfoChange}>
                ...
                <CRow>
                  ...
                  <CCol sm={6}>
                    <CFormInput size="sm" type="text" id="norek" onChange={handleInfoChange} />
                  </CCol>
                </CRow>
              </CCol>
            </CRow>
...
Serta  kebutuhan program penunjang lainnya"
          ...
          <CFooter>
            <CRow>
              <CButton type="submit" disabled={loading} onClick={handleUploadFiles}>
